...
class ProfileRating(db.Model):
    ...
    rater = db.relationship("Profile", foreign_keys=[rater_id], back_populates="rated_profiles")
    ratee = db.relationship("Profile", foreign_keys=[ratee_id], back_populates="ratings")
